...
const Storage = {
    get() {
        return JSON.parse(localStorage.getItem("stonks.finance:transactions")) || []
    },

    set(transactions) {
        localStorage.setItem("stonks.finance:transactions", JSON.stringify(transactions))
    }
}
...
const Transaction = {
    ...
    total () {
        //Todas as entradas - Todas as saídas
